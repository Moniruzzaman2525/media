  ...
  return (
    <div className="navbar py-5 lg:w-3/4 mx-auto">
      ...
      <div className="navbar-center">
        <ul
          className={`md:flex items-center py-8 md:py-0 bg-gray-300 md:bg-base-100 text-gray-900 text-lg md:text-gray-900 font-semibold absolute md:static left-0 md:pl-0 pl-9 w-full md:w-auto transition-all duration-500 ease-in z-10  ${open ? "top-16" : "top-[-600px]"
            }`}
        >
          <li className="p-3 ">
            <Link to="/">Home</Link>
