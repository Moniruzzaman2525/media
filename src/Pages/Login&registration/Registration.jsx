...
import { useCreateUserAcMutation } from "../../redux/EndPoints/ApiEndpoints";
    ...
    <div className="">
      {user && user?.uid ? (
        ...
        <div className="flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0 ">
          ...
          <div className="w-full p-8  mt-8 overflow-hidden bg-gray-200 shadow-md sm:max-w-lg sm:rounded-lg">
